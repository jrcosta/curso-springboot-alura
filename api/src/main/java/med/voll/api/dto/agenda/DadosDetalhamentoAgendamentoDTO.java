...
public record DadosDetalhamentoAgendamentoDTO(Long id, Long medico_id, Long paciente_id, String data_agendamento, String data_atendimento, Long especialidade_id, boolean status, String observacao) {
